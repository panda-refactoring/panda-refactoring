...
export const users = [
  {
    ...
    favorite: [
      {
        id: 1,
        products: productMin.filter(
          ({ id }) => id === 2 || id === 8 || id === 12 || id === 19 || id === 40 || id === 42,
        ),
        looks: looks.filter(({ id }) => id === 2 || id === 5 || id === 6 || id === 10 || id === 12 || id === 15),
      },
    ],
    product: productMin.filter(({ id }) => id === 2 || id === 8 || id === 12 || id === 19 || id === 40 || id === 42),
